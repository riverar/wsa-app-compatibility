...
| iPusnas | 1.5.1 | ✅ | | |
| Instagram | 215.0.0.0.340 | ⚠️ | Can't reply to Stories, often crashes when playing video Stories or Reels, app might flicker when playing videos, a buzz sound comes through when video is played on first app launch, subsequent playbacks don't suffer from this issue || Issues not specific to beta version

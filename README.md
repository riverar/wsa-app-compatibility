...
| Firefox | 101.2.0 (2015885319) | 11/12 | ⚠️ | On Android 11, it works albeit with improperly rendered webpages. On Android 12, webpages doesn't render anymore causing to consume more resources | Tested only on IntelHD integrated graphics (I'm not sure for AMD or NVIDIA GPUs since I don't have it on hand).

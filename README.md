...
| Gycso | 1.1.0 | 11, 12 | ✅ |
| Hatsune Miku: Colorful Stage! | 1.3.2 | | ❌ | App either crashes when loading into game after login or app screen turns dark
...
| プロジェクトセカイ カラフルステージ！ feat. 初音ミク (Project Sekai Colorful Stage JP) | 1.3.2 | | ❌ | App either crashes when loading into game after login or app screen turns dark

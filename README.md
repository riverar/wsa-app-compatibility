...
| Minecraft (Play Store) | 1.20.40.20 | 13, 11 | ⚠️ | Mouse issue: while in-game, moving the camera by scrolling doesn't work, but on game menu, scrolling works as the player's avatar is looking toward the cursor

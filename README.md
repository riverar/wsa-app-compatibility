...
| Berry Browser | 3.55.18 | 11 | ✅
| Binance | 2.36.5 | 11 | ✅
| Blue Archive (GB) | 1.36.120365 | 11 | ❌ | Black screen on app launch
| Blue Archive (KR) | 1.35.115378 | 11 | ❌ | Blank screen on app launch
| Bouncer | 1.26.3 | 11 | ⚠️
...
| CnC Rivals | 1.8.1 | 11 | ✅ | | It will pop up "Won't run without GPlay services" when starts, but works fine except GPlay login. You may use link email instead.
| CPU-Z | 1.41 | 11 | ✅
...
| Google Classroom | 8.0.061.20.90.3 | 11 | ✅ || Notifications are generic (do not show content), clicking on them may not open the app. Uploading of attachments locally is not possible.
...
| YouTube Music (Google) | 4.49.51 | 11 | 🆖 | Requires GMS

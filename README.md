...
| PC Creator 2 - Computer Tycoon | 4.1.5 | 13 | ❌ |Mouse does not work with the tutorial so  you can not complete it thus being stuck| the game starts fine but you can not move the tutorial pc to install windows so the game does not work|
